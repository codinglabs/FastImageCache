 ...
 */
@property (nonatomic, copy, readonly) NSString *ficUUID;
 ...
 */
@property (nonatomic, copy, readonly) NSString *ficSourceImageUUID;
 ...
 */
- (nullable NSURL *)ficSourceImageURLWithFormatName:(NSString *)formatName;
...
- (nullable FICEntityImageDrawingBlock)ficDrawingBlockForImage:(UIImage *)image withFormatName:(NSString *)formatName;
 ...
 */
- (nullable UIImage *)ficImageForFormat:(FICImageFormat *)format;
